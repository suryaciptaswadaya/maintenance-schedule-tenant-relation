    ...
    <div class="card-body p-0">
        <div class="bs-stepper linear">
            ...
            <div class="bs-stepper-content">
                ...
                <div id="category-part" class="content active dstepper-block" role="tabpanel"aria-labelledby="category-part-trigger">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <select id="template-mail" class="form-control select2" style="width: 100%;" name="tempalte">
                                </select>
                            </div>
                        </div>
                    </div>
